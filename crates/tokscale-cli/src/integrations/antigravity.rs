...
pub fn run_cli_command(subcommand: crate::cli::AntigravitySubcommand) -> Result<()> {
    match subcommand {
        crate::cli::AntigravitySubcommand::Sync => run_antigravity_sync(),
        crate::cli::AntigravitySubcommand::Status { json } => run_antigravity_status(json),
        crate::cli::AntigravitySubcommand::PurgeCache => run_antigravity_purge_cache(),
    }
}
